...
public class UI_copy extends JFrame{
    ...
    public void board() {
        ...
        board.setBackground(new Color(255,245,235));
    }
    ...
    class PanelListener implements MouseListener, MouseMotionListener{
        ...
        public void mouseClicked(MouseEvent e) {
            // TODO Auto-generated method stub
            if(e.getX()>(X-CHESSPIECE/2)&&e.getX()<(X+14*((int)SIZE)+CHESSPIECE/2)&&e.getY()>(Y-CHESSPIECE/2)&&e.getY()<(Y+14*((int)SIZE)+CHESSPIECE/2)){
